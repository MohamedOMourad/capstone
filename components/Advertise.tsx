...
export default function Advertise({ products }: { products: Product[] }) {
    ...
    return (
                                ...
                                <a className="group">
                                    <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden  bg-gray-200 xl:aspect-w-5 xl:aspect-h-3">
                                        <Image
                                            ...
                                            className={classNames(
                                                ...
                                                isLoading
                                                    ? 'scale-110 blur-2xl grayscale max-h-10'
                                                    : 'scale-100 blur-0 grayscale-0  max-h-10'
                                            )}
                                    ...
                                    <div className="bg-white">
                                        <div className="p-4">
                                            ...
                                            <p className="text-xs text-gray-600 mt-2 overflow-hidden">{product.description.length <= 25
                                                ? product.description
        ...
        //                             <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden  bg-gray-200 xl:aspect-w-5 xl:aspect-h-3">
        //                                 <div
        //                                     style={{ backgroundImage: `url(${product.images[0].imgUrl})` }}
        //                                     className={'h-40 w-64'}
        //                                 >
        //                                 </div>
        //                             </div>
